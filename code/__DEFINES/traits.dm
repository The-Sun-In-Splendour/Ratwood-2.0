...
#define TRAIT_STANDARD_BEARER_EVIL "Undead Standard Bearer"
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_STANDARD_BEARER_EVIL = span_info("Even in death shall I protect this banner. Her undead legion knows to rally around me, so long as I keep it safe."),
